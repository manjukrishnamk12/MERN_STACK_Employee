      ...
      <Table >
        <TableHead id='thead' >
          <TableRow >
            ...
            <TableCell className="table-cell" align="center">Designation</TableCell>
        ...
        <TableBody>
          {employees.map((employee) => (
            <TableRow key={employee._id}>
              ...
              <TableCell className="table-cell"  align="center">{employee.designation}</TableCell>
              ...
              <EditIcon className="action-button" onClick={()=>updateBlog(employee)} color='secondary' /> 
              </TableCell>
              <TableCell className="table-cell"  align="center">
              <DeleteIcon className="action-button" onClick={() => deletePost(employee._id)} color='secondary'/> 
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
